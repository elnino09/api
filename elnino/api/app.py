...
from elnino.api import config as api_config
from elnino.api import hooks
from elnino import service
from elnino import storage
...
api_opts = [
    cfg.IPOpt('host_ip',
              default='0.0.0.0',
              help='The listen IP for the elnino API server.'),
    cfg.PortOpt('port',
                default=8889,
                help='The port for the elnino API server.'),

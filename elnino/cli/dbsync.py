...
from elnino import config  # noqa
from elnino.db import api as db_api
from elnino import service

CONF = cfg.CONF
PROCESSORS_NAMESPACE = 'elnino.rating.processors'
...
class DBCommand(object):
    ...
    def get_migrations(self, name=None):
        if not name:
            migrations = []
            migrations.append(self.get_module_migration('elnino'))
